 ...
 * OreSat::TopologyState see: OreSatTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type OreSat::TopologyState see: OreSatTopologyDefs.hpp.
 *
